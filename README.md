...
|----|----------|----------|
| <img scr="">  | Терминатор (Пуск/Остановка)  | Обозначает начало или конец алгоритма (начало/конец). |
| <img scr="">  | Процесс  | Выполнение одной или нескольких операций, обработка данных (Например: a = b + c). |
...
| <img scr="">  | Предопределенный процесс  | Вызов вспомогательного алгоритма или функции |
| <img scr="">  | Цикл  | Обозначение цикла с параметром. Содержит условие продолжения цикла. (Пример: Для i от 1 до 10, Пока счетчик < 100) |
| <img scr="">  | Соединитель  | Используется для обрыва и соединения линий в разных частях одной схемы (удобно для больших схем, чтобы избежать множества пересекающихся линий). Обозначение перехода к другой части схемы. |
| <img scr="">  | Линия потока  | Стрелки, показывающие последовательность выполнения шагов алгоритма и связь между блоками. |
